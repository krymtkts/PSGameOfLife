#
# Module manifest for module 'PSGameOfLife'
#
...
@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/krymtkts/PSGameOfLife/'
...
Full CHANGELOG: https://github.com/krymtkts/PSGameOfLife/blob/main/CHANGELOG.md
'@
